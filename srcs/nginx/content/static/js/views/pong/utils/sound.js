...
export const soundBtn = (objectManager, signal) => {
  let soundBool = false;
  let volume = 0.5;
  ...
  volumeBar.addEventListener(
    ...
    (e) => {
      ...
      if (objectManager.sound) objectManager.sound.setVolume(volume);
    },
    {
      signal: signal,
    }
  ...
  soundBtn.addEventListener(
    ...
    () => {
      ...
      if (soundBool && !objectManager.sound)
        objectManager.sound = addSound(objectManager.camera, volume);
      else if (soundBool) objectManager.sound.play();
      else objectManager.sound.pause();
    },
    {
      signal: signal,
    }
